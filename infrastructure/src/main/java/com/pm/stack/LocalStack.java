...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck clientDbHealthCheck = createCfnHealthCheck(clientServiceDb, "ClientServiceDbHealthCheck");
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "R9Xt4+2evAVqwH3kQxxjY2x+oQLo3re2DdaKhxPuP+o="));
        ...
        FargateService patientService = createFargateService("ClientService",
                "client-service",
                List.of(4000),
                clientServiceDb,
                Map.of(
        ...
        patientService.getNode().addDependency(clientServiceDb);
        patientService.getNode().addDependency(clientDbHealthCheck);
    ...
    private Vpc createVpc() {
        return Vpc.Builder
                .create(this, "ClientManagementVPC")
                .vpcName("ClientManagementVPC")
                .maxAzs(2)
                .build();
    }
    ...
    private DatabaseInstance createDatabase(String id, String dbName){
        return DatabaseInstance.Builder
                .create(this, id)
                .engine(DatabaseInstanceEngine.postgres(PostgresInstanceEngineProps.builder().version(
    ...
    //allow other services to check how the db is doing
    ...
    private Cluster createEcsCluster(){
        return Cluster.Builder.create(this, "ClientManagementCluster")
                .vpc(vpc)
                .defaultCloudMapNamespace(CloudMapNamespaceOptions.builder()
                        .name("client-management.local")
                        .build())
                .build();
    }
